            ...
            <div class="table-responsive">
              ...
              <table class="table table-hover">
                ...
                <tr>
                  ...
                  <td><a href="Comments.php?Unapprove_ID=<?php echo $comment_id; ?>"><button
                        class="btn btn-danger">Unapprove</button></a></td>
                  <?php
								$postNo++;
								}
								}
            ...
            <div class="table-responsive">
              ...
              <table class="table table-hover">
                ...
                <tr>
                  ...
                  <td><a href="Comments.php?Approve_ID=<?php echo $comment_id; ?>"><button
