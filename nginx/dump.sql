...
INSERT INTO `Авторы` VALUES (1,'Пушкин','Александр','Сергеевич','Российская империя',14,6,'bio1','2019-02-11 16:01:44'),(2,'Достоевский','Федор','Михайлович','Российская империя',13,5,'bio2','2019-02-13 16:01:44'),(3,'Маяковский','Владимир','Владимирович','СССР',14,7,'bio3','2019-02-15 16:01:44'),(5,'Булгаков','Михаил','Афанасьевич','СССР',13,7,'bio5','2019-02-01 16:01:44'),(6,'Толстой','Лев','Николаевич','Российская империя',13,6,'bio6','2019-03-11 16:01:44'),(7,'Бальзак','Оноре де','','Франция',15,6,'bio7','2019-03-13 03:08:07');
...
INSERT INTO `Периоды` VALUES (1,'Античная литература'),(2,'Средневековая литература'),(3,'Литература эпохи Возрождения'),(4,'XVII век'),(5,'XVIII век'),(6,'XIX век'),(7,'XX век'),(8,'XXI век'),(9,'XIX векtest'),(10,'sdfg'),(11,'Крутой период'),(12,'Крутой период ghfghfg');
...
INSERT INTO `Пользователи` VALUES (1,'test','test@test.ru','test',1,2,'2019-02-18 16:01:44','2019-02-18 16:01:44'),(2,'test2','test2@test.ru','test',1,1,'2019-02-18 16:01:44','2019-02-18 16:01:44'),(3,'tiranid','masmkf@mail.ru','fkgokfdmgvfd',2,2,'2019-02-18 16:01:44','2019-02-18 16:01:44'),(7,'test123','sample-admin@test.ru','12',1,2,'2019-03-06 15:52:46','2019-03-06 15:52:46'),(9,'test2','sample-admin@test.ru','123',1,2,'2019-03-06 15:53:44','2019-03-06 15:53:44'),(11,'test-admin','sample-admin@test.ru','1234',1,2,'2019-03-06 15:56:59','2019-03-06 15:56:59'),(13,'new_user','new_user@some_email.com','555',1,1,'2019-03-07 13:41:24','2019-03-07 13:41:24'),(14,'tester_user1','email@com','123',1,1,'2019-03-07 13:48:35','2019-03-07 13:48:35'),(15,'tester_user12','email@com','12',1,1,'2019-03-07 13:50:21','2019-03-07 13:50:21'),(16,'да','мда','бда',1,1,'2019-03-06 15:52:45','2019-03-06 15:52:45'),(17,'tester_user123','email@com','12',1,1,'2019-03-07 13:54:50','2019-03-07 13:54:50'),(18,'testwerewrwe','ewrweqr','123',1,1,'2019-03-07 13:56:06','2019-03-07 13:56:06'),(19,'MonsterBoomerACDC','ti@gnida','123',1,1,'2019-03-07 13:56:34','2019-03-07 13:56:34'),(20,'wqewe','wqewqe','123',1,1,'2019-03-07 13:57:12','2019-03-07 13:57:12'),(21,'wqewe213','wqewqe','123',1,1,'2019-03-07 13:58:33','2019-03-07 13:58:33'),(22,'213213','12321','123',1,1,'2019-03-07 14:00:43','2019-03-07 14:00:43'),(23,'tiranid99','kek@mail.ru','12',1,2,'2019-03-11 10:22:43','2019-03-11 10:22:43'),(24,'test111','test@test.com','123',1,1,'2021-05-18 09:41:02','2021-05-18 09:41:02');
...
INSERT INTO `Разрешения` VALUES (1,'комментирование',NULL,NULL),(2,'добавление статей',NULL,NULL),(3,'модерация комментариев',NULL,NULL),(4,'модерация статей',NULL,NULL),(5,'добавление цитат',NULL,NULL);
...
INSERT INTO `Сферы_деятельности` VALUES (1,'Экономика'),(2,'Экология'),(3,'Управление'),(4,'Педагогика'),(5,'Медицина'),(6,'Физкультура'),(7,'Наука'),(8,'Искусство'),(9,'kek'),(10,'Искусствоtest'),(11,'dfgs'),(12,'Крутые сферы'),(13,'Писатель'),(14,'Поэт'),(15,'Прозаик');
...
DELIMITER ;;
CREATE TRIGGER `РазрешенияonInsert` BEFORE INSERT ON `Разрешения` FOR EACH ROW
BEGIN
    SET NEW.created_at = NOW();
END;;
CREATE TRIGGER `РазрешенияonUpdate` BEFORE UPDATE ON `Разрешения` FOR EACH ROW
BEGIN
    SET NEW.updated_at = NOW();
END;;
CREATE TRIGGER `ЦитатыonUpdate` BEFORE UPDATE ON `Цитаты` FOR EACH ROW
BEGIN
    SET NEW.дата_обновления = NOW();
END;;
END;;
CREATE TRIGGER `АвторыonUpdate` BEFORE UPDATE ON `Авторы` FOR EACH ROW
BEGIN
    SET NEW.дата_обновления = NOW();
END;;
...
-- Dump completed on 2021-05-18 11:51:24
